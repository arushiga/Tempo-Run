        ...
        <div className="max-w-md w-full">
            ...
            <div className="px-8 py-8 space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-2 border-white/60 backdrop-blur-md bg-white/50 checked:bg-gradient-to-br checked:from-violet-500 checked:to-fuchsia-500"
                  />
                  <span className="text-[13px] text-slate-700 font-medium">Remember me</span>
                </label>
                <Link to="/forgot-password" className="text-[13px] text-violet-600 hover:text-fuchsia-600 font-semibold transition-colors">
                  Forgot Password?
                </Link>
              </div>
              ...
              <div className="text-center pt-2">
                <p className="text-[14px] text-slate-600">
                  ...
                  <Link to="/signup" className="text-violet-600 hover:text-fuchsia-600 font-bold transition-colors">
                    Sign Up
                  </Link>
                </p>
              </div>
          ...
          <div className="text-center mt-6">
            <p className="text-[12px] text-slate-500">
              ...
              <a href="#" className="text-violet-600 hover:text-fuchsia-600 font-semibold">Terms</a>
              {' '}and{' '}
              <a href="#" className="text-violet-600 hover:text-fuchsia-600 font-semibold">Privacy Policy</a>
            </p>
          </div>
        </div>
      </div>
